...
import com.fruit.dao.EvaimgMapper;
import com.fruit.dao.EvaluateMapper;
...
public class EvaluateServiceImpl implements IEvaluateService {
	...
	public Integer addEvaluate(Evaluate eva,String[] imgs) {
		Integer rs = evaluateMapper.insertSelective(eva);
		if(rs>0){
			for (String img : imgs) {
	...
	public Evaluate findEvaluteById(Integer evaId) {
		System.out.println(evaId +"ssss");
		Evaluate eva = evaluateMapper.selectByPrimaryKey(evaId);       
