...
public class BannerController {
	...
	public JSONObject uploadBannerImg(@PathVariable(value="file")MultipartFile file,HttpServletRequest request){
		...
		String path="D:\\dql\\fruit\\src\\main\\webapp\\upload\\"+name;
	...
	@ResponseBody
	public String changeBannerState(Integer bannerId, Integer bannerState){
		Integer rs = bannerService.changeBannerState( bannerId,  bannerState);
		if(rs>0){
			return "success";
		}else{
			return "fail";
