	...
	<div id="editForm" style="width: 700px; padding-top: 10px;">
		<form id="formData" class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="goodsUnit" id="goodsUnit" required
						lay-verify="required" placeholder="请输入商品单位" value=""
						class="layui-input" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="goodsVolume" id="goodsVolume" required
