...
<div id="formData" style="width:700px;display:none;padding-top:15px;">
	<form class="layui-form" id="userForm">
		...
		<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="userPhone" id="userPhone" required lay-verify="phone"value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item">
			    <label class="layui-form-label">邮箱</label>
			    <div class="layui-input-block">
			      <input type="text" name="userEmail" id="userEmail" requiredlay-verify="email" value="" class="layui-input" />
			    </div>			    
		</div>
		<div class="layui-form-item">
            ...
            var tableIns = table.render({
                ...
                , cols: [[
                   ...
                   ,{ field:'userState', title: '用户状态', width: 112, align: 'center',templet: function(d){          
                	   if(d.userState==1){
                        	  return "<input type='checkbox' lay-filter='switchTest' name='"+d.userId+"' lay-skin='switch' lay-text='禁用|正常'><input type='hidden' id='kaigID' value='"+d.userId+"' />"
                     	 }else{                    	 
                       	  return "<input type='checkbox' lay-filter='switchTest' name='"+d.userId+"' lay-skin='switch' lay-text='禁用|正常' checked><input type='hidden' id='kaigID' value='"+d.userId+"' />"
                     	 }		  
                	 }
